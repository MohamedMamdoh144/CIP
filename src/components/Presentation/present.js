    ...
    window.addEventListener("hashchange",(e)=>{
        ...
        if(step==="step-1"){
            ...
            step7_h1.unfreeze();
             ...
             step10_h1.unfreeze();
             slideGroups.second.forEach((el)=>{gsap.set("#"+el+">*:not(.intro-main-btn)",{opacity:1,delay:0.6})});
         }
            ...
            slideGroups.third.forEach((el)=>{gsap.set("#"+el+">*:not(.intro-main-btn)",{opacity:1,delay:0.6})});
            step14_h1.unfreeze();
        ...
        if(step_num>=2 && step_num<=7){
            slideGroups.first.forEach((el)=>{gsap.set("#"+el+">*:not(.intro-main-btn)",{opacity:1,delay:0.6})});
        }
        else  if(step_num>=9 && step_num<=13){
            slideGroups.second.forEach((el)=>{gsap.set("#"+el+">*:not(.intro-main-btn)",{opacity:1,delay:0.6})});
        }
        else  if(step_num>=10 && step_num<=11){
            slideGroups.third.forEach((el)=>{gsap.set("#"+el+">*:not(.intro-main-btn)",{opacity:1,delay:0.6})});
        }
        ...
        {/* STEP-1 */}
         ...
         <Step duration={600}
            ...
            <Step duration={600}
                ...
                <h1 className='intro-h1'>
                    ...
                    options={{speed:80,afterComplete:()=>{
                        step1_h3.unfreeze();step1_h1.destroy();
                ...
                <h3 className='intro-h3'>
                    ...
                    options={{speed:90,afterComplete:()=>{
                        ...
                        gsap.to("#step-2 .intro-h3",{duration:0.5,opacity:1});
                    }}}
                    />
                </h3>
                <h4 className='intro-h4'>
                    ...
                    options={{speed:80,lifeLike:false,afterComplete:()=>{gsap.to("#step-2 .intro-main-btn",{duration:0.5,opacity:1,delay:0.15});step1_h4.destroy();}}}
                    />
                </h4>
                ...
                <TypeIt getBeforeInit={(instance) => {
                    setStep4_h1(instance);
                      ...
                      options={{speed:80,afterComplete:()=>{
                        ...
                        tl.fromTo("#step-4 .summary-h1",{fontSize:"72px",y:100},{duration:0.7,fontSize:"48px",y:0});
                    ...
                    <ul className='symptom-list'>
                      ...
                      <li className='symptom-item'><ListItem id={2} text={"Diarrhea"} radius={180} /></li>
                      <li className='symptom-item'><ListItem id={3} text={"Cough"} radius={160} /></li>
                    </ul>
                      {/*Add an icon*/}
            ...
            <Step duration={600}
                ...
                <h1 className='summary-h1' style={{fontSize:"36px",marginBottom:"15vh",lineHeight:1.6}}>
                <TypeIt getBeforeInit={(instance) => {
                    setStep6_h1(instance);
                          instance.type("After perfroming qualitative PCR, the patient tested positive for COVID-19<br/>").pause(1800)
            ...
            <Step duration={600}
                ...
                data={{
                 ...
                 <h1 className='intro-h1'>
                    ...
                    options={{speed:200,lifeLike:false,afterComplete:()=>{step7_h3.unfreeze();step7_h1.destroy();}}
                ...
                <h3 className='intro-h3'>
                    ...
                    options={{speed:90,afterComplete:()=>{step7_h4.unfreeze();step7_h3.destroy();}}}
                    />
                </h3>
                <h4 className='intro-h4'>
                    <TypeIt getBeforeInit={(instance) => {
                    ...
                    options={{speed:80,lifeLike:false,afterComplete:()=>{gsap.to("#step-7 .intro-main-btn",{duration:0.5,opacity:1,delay:0.15});step7_h4.destroy();}}}
                    />
                </h4>
                <MainBtn call={handler} text={"Continue"}/>
               ...
               <h1 className='summary-h1'>
                <TypeIt getBeforeInit={(instance) => {
                    setStep10_h1(instance);
                      ...
                      options={{speed:80,afterComplete:()=>{
                        let tl=gsap.timeline();
                        tl.fromTo("#step-10 .summary-h1",{fontSize:"72px",y:100},{duration:0.7,fontSize:"48px",y:0});
                    ...
                    <ul className='symptom-list'>
                        ...
                        <li className='symptom-item'><ListItem id={2} text={"Rigidity"} radius={160} /></li>
                        <li className='symptom-item'><ListItem id={3} text={"Slow Movements"} radius={230} /></li>
                    </ul>
            ...
            <Step duration={600}
                ...
                <h1 className='intro-h1'>
                    ...
                    options={{speed:200,lifeLike:true,afterComplete:()=>{step12_h3.unfreeze();step12_h1.destroy();}}
                ...
                <h3 className='intro-h3'>
                    ...
                    options={{speed:90,afterComplete:()=>{step12_h4.unfreeze();step12_h3.destroy();}}}
                    />
                </h3>
                <h4 className='intro-h4'>
                    <TypeIt getBeforeInit={(instance) => {
            ...
            data={{
                ...
                rotateZ:270
                  ...
                  getBeforeInit={(instance) => {
                    setStep13_h1(instance);
                        instance.exec(()=>{gsap.to("#step-13 .dialogue",{duration:0.8,fontSize:"36px",y:-30})})
                        ...
                        .delete(null,{instant:true})
                        .type("Management:<br><i style='font-size: 24px;'>200/50mg of levodopa/benserazide three times a day</i>")
                        .freeze();
                    return instance;
                    }}
                    options={{speed:80,afterComplete:()=>{
                        let tl=gsap.timeline();
                        tl.set("#step-13 .dialogue-h3",{opacity:1,fontSize:"26px",width:"100%",marginLeft:0,textAlign:"center"});
                   ...
                   <div style={{width:"100%",marginTop:"10vh"}}>
                    ...
                    options={{speed:80,lifeLike:false,afterComplete:()=>{
                        let tl=gsap.timeline();
                ...
                <h4 className='dialogue-h4'>
                    <TypeIt getBeforeInit={(instance) => {
                        ...
                        instance.type("Want to learn more about the pathogensis?").pause(800)
                        .delete(16)
                        .type("how artificial intelligence can diagnose parkisnonism?")
                        .pause(800).delete(null,{instant:true})
                        .type("Or even how we created this app").pause(800)
                        .delete(null,{instant:true})
                    ...
                    options={{speed:90,lifeLike:false,afterComplete:()=>{
                        let tl=gsap.timeline();
                        tl.to(".menu",{duration:0.6,opacity:0.5,repeat:3});
                        tl.to(".menu",{duration:0.4,opacity:1,ease:"back.out(1.7)"});
            ...
            data={{
                  ...
                  getBeforeInit={(instance) => {
                    setStep14_h1(instance);
                        instance.type("Now, let's talk a little bit about diagnosis").pause(1000).delete(20).exec(()=>{gsap.to("#step-14 .dialogue",{duration:0.8,fontSize:"36px",y:-30})})
                        .delete()
                        .type("In fact, there are many diagnostic criteria that can diagnose parkinson's disease<br/>").pause(800)
                        .type("<strong style='color:#d74582;'>However,..</strong>").pause(1200).delete(10)
                        .type("Most of them share a couple of drawbacks").pause(800)
                        .delete(null,{instant:true}).type("Drawbacks of diagnostic criteria")
                        .exec(()=>{gsap.to("#step-14 .dialogue",{duration:0.5,fontSize:"48px",y:-65})})
                        .pause(500).freeze();
                    return instance;
                    }}
                    options={{speed:80,afterComplete:()=>{
                ...
                <h4 className='dialogue-h4'>
                    <TypeIt getBeforeInit={(instance) => {
                        ...
                        instance.type("Fortunately, our story doesn't end here because AI is all in for help").pause(500)
                        .delete(null,{instant:true})
               ...
               <h1 className='summary-h1'>
                <TypeIt getBeforeInit={(instance) => {
                    setStep15_h1(instance);
                          ...
                          .exec(()=>{ gsap.fromTo("#step-15 .summary-h1",{fontSize:"72px"},{duration:0.7,fontSize:"50px"});})
                          .delete(null,{instant:true})
                      ...
                      options={{speed:80,afterComplete:()=>{
                        let tl=gsap.timeline();
                        tl.fromTo("#step-15 .summary-h1",{fontSize:"50px",y:100},{duration:0.7,fontSize:"40px",y:0});
