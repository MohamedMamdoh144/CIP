...
function App() {
 ...
 /* Scene 1','Scene 2','Management',
  ...
  return (
    <>
    <Navigation  show={show} setshow={setshow} setpage={setPage} setclose={setclose} />
    <Menu show={show} setshow={setshow} close={close} setclose={setclose} />
    <IntroSlide />
    <div className='hint-intro'>You can use <strong>Spacebar</strong> or click the buttons to navigate</div>
    </>
